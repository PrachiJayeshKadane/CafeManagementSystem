...
function displayItems(){
    ...
    var mocktail= document.getElementById('mocktail');
    ...
    const mocktailData= foodItem.filter(item=> item.category=='mocktail');
    console.log(mocktailData);
